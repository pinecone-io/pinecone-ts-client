...
pc.indexes.createIndex(options)
pc.indexes.createIndexForModel(options)
pc.indexes.configureIndex(options)
pc.indexes.describeIndex(name)
pc.indexes.listIndexes()
...
pc.indexes.createIndexFromBackup(options)
