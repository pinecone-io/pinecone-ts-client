...
export function QueryRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    includeValues: !exists(json, 'includeValues')
      ? undefined
      : json['includeValues'],
    includeMetadata: !exists(json, 'includeMetadata')
      ? undefined
      : json['includeMetadata'],
    queries: !exists(json, 'queries')
      ? undefined
      : (json['queries'] as Array<any>).map(QueryVectorFromJSON),
    vector: !exists(json, 'vector') ? undefined : json['vector'],
    sparseVector: !exists(json, 'sparseVector')
      ? undefined
      : SparseValuesFromJSON(json['sparseVector']),
  ...
  return {
    ...
    queries:
      value.queries === undefined
        ? undefined
        : (value.queries as Array<any>).map(QueryVectorToJSON),
    vector: value.vector,
