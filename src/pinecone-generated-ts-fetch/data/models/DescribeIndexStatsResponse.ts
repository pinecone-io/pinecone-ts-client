...
export function DescribeIndexStatsResponseFromJSON(
  json: any
): DescribeIndexStatsResponse {
  return DescribeIndexStatsResponseFromJSONTyped(json, false);
}

export function DescribeIndexStatsResponseFromJSONTyped(
  json: any,
  ...
  return {
    namespaces: !exists(json, 'namespaces')
      ? undefined
      : mapValues(json['namespaces'], NamespaceSummaryFromJSON),
    dimension: !exists(json, 'dimension') ? undefined : json['dimension'],
    indexFullness: !exists(json, 'indexFullness')
      ? undefined
      : json['indexFullness'],
    totalVectorCount: !exists(json, 'totalVectorCount')
      ? undefined
      : json['totalVectorCount'],
  };
}

export function DescribeIndexStatsResponseToJSON(
  value?: DescribeIndexStatsResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    namespaces:
      value.namespaces === undefined
        ? undefined
        : mapValues(value.namespaces, NamespaceSummaryToJSON),
