...
export function PodSpecFromJSONTyped(
  json: any,
  ...
  return {
    ...
    pods: json['pods'],
    metadataConfig: !exists(json, 'metadata_config')
      ? undefined
      : PodSpecMetadataConfigFromJSON(json['metadata_config']),
    sourceCollection: !exists(json, 'source_collection')
      ? undefined
