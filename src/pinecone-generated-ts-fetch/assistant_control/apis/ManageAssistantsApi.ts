...
import {
    ...
    UpdateAssistantResponseFromJSON,
    UpdateAssistantResponseToJSON,
} from '../models/index';
...
export class ManageAssistantsApi extends runtime.BaseAPI {
     ...
     * Update an assistant
     */
    async updateAssistantRaw(requestParameters: UpdateAssistantOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UpdateAssistantResponse>> {
        if (requestParameters.xPineconeApiVersion === null || requestParameters.xPineconeApiVersion === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UpdateAssistantResponseFromJSON(jsonValue));
    }
     ...
     * Update an assistant
     */
    async updateAssistant(requestParameters: UpdateAssistantOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UpdateAssistantResponse> {
