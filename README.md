...
- The Pinecone TypeScript SDK is compatible with TypeScript >=5.2.0 and Node.js >=20.0.0. CI runs the test suite against Node.js 20.x, 22.x, and 24.x (the current Active LTS). Node 20 reached end-of-life on 2026-04-30 and no longer receives security patches; new projects should target Node 22 or later, and a future release will raise the minimum supported version to >=22.0.0.
